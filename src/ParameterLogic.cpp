...
void applySoftBackgroundOvalBokeh(RenderParams &params) {
  ...
  params.enableBokeh = 1;
  params.bokehAmount = 0.45f;
  params.focusWidth = 0.08f;
  params.focusFalloff = 0.15f;
  params.maxBokehRadius = 18.0f;
  params.nearBlurAmount = 0.6f;
  params.farBlurAmount = 1.0f;
  params.ovalRatio = 1.65f;
  params.ovalOrientation = 0;
  params.depthEdgeProtect = 8.0f;
  params.highlightBokehEnable = 1;
  params.highlightThreshold = 0.75f;
  params.highlightSoftness = 0.35f;
  params.highlightGain = 0.35f;
  params.highlightRadiusMultiplier = 1.8f;
  params.rimBrightness = 0.2f;
  params.apertureSoftness = 0.08f;
  params.catEyeAmount = 0.15f;
  params.bokehCAAmount = 0.05f;
...
void applyWaterfallBokehExperimental(RenderParams &params) {
  ...
  params.enableBokeh = 1;
  params.bokehAmount = 0.62f;
  params.focusWidth = 0.06f;
  params.focusFalloff = 0.18f;
  params.maxBokehRadius = 28.0f;
  params.nearBlurAmount = 0.8f;
  params.farBlurAmount = 1.2f;
  params.ovalRatio = 2.0f;
  params.ovalOrientation = 0;
  params.depthEdgeProtect = 10.0f;
  params.foregroundEdgeProtect = 16.0f;
  params.highlightBokehEnable = 1;
  params.highlightThreshold = 0.7f;
  params.highlightSoftness = 0.4f;
  params.highlightGain = 0.48f;
  params.highlightRadiusMultiplier = 2.2f;
  params.rimBrightness = 0.35f;
  params.apertureSoftness = 0.1f;
  params.catEyeAmount = 0.35f;
  params.bokehCAAmount = 0.1f;
